...
public class Controller {
	...
	public void onResumeButtonClick(ActionEvent event)
	{
		velop = 2;
	}
	public void initialize() {
		...
		pauseButton.setOnAction(this::onPauseButtonClick);
		resumeButton.setOnAction(this::onResumeButtonClick);
		...
		Timeline timeline = new Timeline(
				new KeyFrame(Duration.millis(16), event -> {
					...
					background.setLayoutX(background.getLayoutX() - velop);
					background2.setLayoutX(background2.getLayoutX() - velop);
